...
<Callout type="default">
  CSPR.AI is powered by the full Casper Network ecosystem
</Callout>

| **Casper Technology** | **How We Use It** |
|----------------------|-------------------|
| 🔗 **[casper-js-sdk](https://github.com/casper-ecosystem/casper-js-sdk)** | Core SDK for RPC communication and transaction building |
| 💼 **[CSPR.click Wallet](https://cspr.click)** | Client-side transaction signing (non-custodial) |
| ⚙️ **[Odra Framework](https://odra.dev)** | Type-safe Rust smart contracts |
| 📜 **CEP-18 & CEP-78** | Official token and NFT standards |
| 🌐 **Casper RPC + CSPR.cloud API** | Network queries and indexed data |

**Security:** All transaction signing happens client-side - CSPR.AI never handles private keys.
